...
\node[block, shading=bottleshading, right=1.2cm of split] (c3k1) {C3k N=2};

% This second bottleneck is placed further away to leave space for the 'N..' text.
\node[block, shading=bottleshading, right=2.4cm of c3k1] (c3k2) {C3k N=2};

\node[block, shading=concatshading, right=1.2cm of c3k2] (concat) {Concat};
...
\draw[->, arrow] (split) -- (c3k1);
% The arrow from c3k1 goes to the 'dots' node, and from there to c3k2.
\draw[->, arrow] (c3k1) -- (dots);
\draw[->, arrow] (dots) -- (c3k2);
\draw[->, arrow] (c3k2) -- (concat);
...
\coordinate (b1_start) at ([xshift=7pt]c3k1.east);
